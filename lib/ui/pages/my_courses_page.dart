    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Offstage(
            //Ho usato "Offstage" invece di "Visibility", perchè la seconda lascia lo SPAZIO BIANCO (rende invisibile l'oggetto, ma continua ad occupare spazio), mentre la prima NO (Sparisce senza occupare spazio bianco)
            ...
            child: Column(
              children: [
                ...
                ElevatedButton(
                    child: const Text('Applica filtro'), onPressed: () {}),
              ],
            ),
          ),
          Divider(),
