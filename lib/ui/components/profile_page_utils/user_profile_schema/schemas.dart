...
FieldDefinition(key: 'sportFrequency',      label: 'Frequenza Sport',    type: FieldDataType.string),
FieldDefinition(key: 'activityLevel',       label: 'Livello attività',   type: FieldDataType.string),
FieldDefinition(key: 'smoker',              label: 'Fumatore',           type: FieldDataType.string),
...
FieldDefinition(key: 'sleepHours',          label: 'Sonno (h)',          type: FieldDataType.number, unit: 'h', decimals: 1),
