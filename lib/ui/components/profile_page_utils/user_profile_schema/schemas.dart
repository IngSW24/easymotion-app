...
const personalSchema = <FieldDefinition>[
  ...
  FieldDefinition(
      key: 'middleName', label: 'Secondo nome', type: FieldDataType.string),
  FieldDefinition(
      key: 'lastName', label: 'Cognome', type: FieldDataType.string),
  FieldDefinition(
      key: 'birthDate', label: 'Data nascita', type: FieldDataType.date),
  FieldDefinition(key: 'email', label: 'Email', type: FieldDataType.string),
  FieldDefinition(
      key: 'phoneNumber', label: 'Cellulare', type: FieldDataType.string),
];
...
const healthSchema = <FieldDefinition>[
  ...
  FieldDefinition(
      ...
      decimals: 0),
  FieldDefinition(
      key: 'profession', label: 'Professione', type: FieldDataType.string),
...
//FieldDefinition(key: 'smoker',              label: 'Fumatore',                                              type: FieldDataType.boolean),
  ...
  FieldDefinition(
      ...
      type: FieldDataType.string),
  FieldDefinition(
      key: 'medications', label: 'Farmaci assunti', type: FieldDataType.string),
  FieldDefinition(
      key: 'allergies', label: 'Allergie', type: FieldDataType.string),
  FieldDefinition(
      key: 'otherPathologies', label: 'Patologie', type: FieldDataType.string),
...
//FieldDefinition(key: 'lastMedicalCheckup',  label: 'Ultimo check-up',                                       type: FieldDataType.date),
  FieldDefinition(
      key: 'personalGoals', label: 'Obiettivi', type: FieldDataType.string),
