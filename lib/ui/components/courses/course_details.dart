      ...
      child: Column(
        ...
        children: [
          ...
          ClipRRect(
            ...
            child: Image.network("${StaticResources.uri}/${courseEntity?.category.id}.jpg"),
          ),
          ...
          RichText(
            text: TextSpan(
                style: TextStyle(color: Colors.black, fontSize: 14),
                children: <TextSpan>[
                  TextSpan(text: "\nCreato il: ", style: TextStyle(fontWeight: FontWeight.bold),),
                  TextSpan(text: "${courseEntity?.createdAt.year}/${courseEntity?.createdAt.month}/${courseEntity?.createdAt.day}"),
                ]
            ),
          ),
          RichText(
            text: TextSpan(
                style: TextStyle(color: Colors.black, fontSize: 14),
                children: <TextSpan>[
                  TextSpan(text: "\nCosto (in Euro): ", style: TextStyle(fontWeight: FontWeight.bold),),
          ...
          RichText(
            text: TextSpan(
                style: TextStyle(color: Colors.black, fontSize: 14),
                children: <TextSpan>[
                  TextSpan(text: "\nIstruttori: ", style: TextStyle(fontWeight: FontWeight.bold),),
