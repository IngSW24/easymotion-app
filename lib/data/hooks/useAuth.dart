...
UseMutationResult<IntersectionAccessTokenDtoAuthUserDto?, Exception, SignInDto> useLoginFn(BuildContext ctx) {
  final apiProvider = Provider.of<ApiProvider>(ctx);
  return useMutation<IntersectionAccessTokenDtoAuthUserDto? , Exception, SignInDto, Null>((
      SignInDto loginInfo) async {
